...
// Check if the request method is POST and course_code is set
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['course_code'])) {
    ...
    try {
        ...
        // Log the error
        error_log("Error in handle_progress.php: " . $e->getMessage());
    ...
    // If accessed without POST request, redirect to myprogress.php
    header('Location: ../public/myprogress.php');
    exit();
}
?>
